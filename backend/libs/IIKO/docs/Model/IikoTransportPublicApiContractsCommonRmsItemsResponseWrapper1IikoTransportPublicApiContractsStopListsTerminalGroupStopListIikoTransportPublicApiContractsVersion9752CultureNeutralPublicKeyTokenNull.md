...
**items** | [**\IIKO\Model\IikoTransportPublicApiContractsStopListsTerminalGroupStopList[]**](IikoTransportPublicApiContractsStopListsTerminalGroupStopList.md) | Items for organization. |
