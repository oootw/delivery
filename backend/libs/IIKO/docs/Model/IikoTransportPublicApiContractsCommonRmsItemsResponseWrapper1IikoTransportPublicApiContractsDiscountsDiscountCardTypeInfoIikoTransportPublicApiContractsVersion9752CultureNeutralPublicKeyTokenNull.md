...
**items** | [**\IIKO\Model\IikoTransportPublicApiContractsDiscountsDiscountCardTypeInfo[]**](IikoTransportPublicApiContractsDiscountsDiscountCardTypeInfo.md) | Items for organization. |
