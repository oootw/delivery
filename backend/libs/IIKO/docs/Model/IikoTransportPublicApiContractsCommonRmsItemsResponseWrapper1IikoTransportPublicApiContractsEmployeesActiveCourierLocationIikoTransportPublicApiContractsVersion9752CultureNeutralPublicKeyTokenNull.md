...
**items** | [**\IIKO\Model\IikoTransportPublicApiContractsEmployeesActiveCourierLocation[]**](IikoTransportPublicApiContractsEmployeesActiveCourierLocation.md) | Items for organization. |
