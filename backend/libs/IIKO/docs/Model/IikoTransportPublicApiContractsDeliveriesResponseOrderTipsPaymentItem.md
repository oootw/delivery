...
------------ | ------------- | ------------- | -------------
**tips_type** | [**\IIKO\Model\IikoTransportPublicApiContractsDeliveriesResponseOrderCancelCause**](IikoTransportPublicApiContractsDeliveriesResponseOrderCancelCause.md) | Tips type. | [optional]
