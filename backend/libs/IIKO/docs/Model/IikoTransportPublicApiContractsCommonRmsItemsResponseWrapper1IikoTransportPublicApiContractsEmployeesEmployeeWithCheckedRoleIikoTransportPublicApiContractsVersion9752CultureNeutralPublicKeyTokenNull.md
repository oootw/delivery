...
**items** | [**\IIKO\Model\IikoTransportPublicApiContractsEmployeesEmployeeWithCheckedRole[]**](IikoTransportPublicApiContractsEmployeesEmployeeWithCheckedRole.md) | Items for organization. |
