...
/**
 * IikoNetServiceContractsApiIikoTransportCustomerGuestCardInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoNetServiceContractsApiIikoTransportCustomerGuestCardInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoNet.Service.Contracts.Api.iikoTransport.Customer.GuestCardInfo';
    ...
    protected static $openAPIFormats = [
        ...
        'track' => null,
        'number' => null,
        'valid_to_date' => 'yyyy-MM-dd HH:mm:ss.fff'
    ];
     ...
     * Sets track
     *
     * @param string|null $track Card track.
     *
     * @return self
     */
     ...
     * Sets valid_to_date
     *
     * @param string|null $valid_to_date Card valid to date.
     *
     * @return self
     */
