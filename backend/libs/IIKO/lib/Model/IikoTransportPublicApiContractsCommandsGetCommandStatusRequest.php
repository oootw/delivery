...
/**
 * IikoTransportPublicApiContractsCommandsGetCommandStatusRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoTransportPublicApiContractsCommandsGetCommandStatusRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Commands.GetCommandStatusRequest';
     ...
     *
     * @param string $organization_id Organization id which \"correlationId\" belongs to.                Can be obtained by `/api/1/organizations` operation.
     *
     * @return self
     */
