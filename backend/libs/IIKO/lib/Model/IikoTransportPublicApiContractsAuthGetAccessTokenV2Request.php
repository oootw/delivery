...
/**
 * IikoTransportPublicApiContractsAuthGetAccessTokenV2Request Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoTransportPublicApiContractsAuthGetAccessTokenV2Request implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Auth.GetAccessTokenV2Request';
     ...
     * Sets api_key
     *
     * @param string $api_key API key generated in iikoWeb under \"Integrations → API Keys\".   The key determines which restaurant organizations the token grants access to.
     *
     * @return self
     */
     ...
     * Sets app_id
     *
     * @param string $app_id Unique application identifier issued by the iiko Developer Portal (https://public-api.iikoweb.ru/portal).  You receive it when you register a new application in your developer account.  The `appId` never changes for the lifetime of the application.
     *
     * @return self
     */
