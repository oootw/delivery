...
/**
 * IikoTransportPublicApiContractsDeliveriesRequestCreateOrderIikoCardDiscountItem Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoTransportPublicApiContractsDeliveriesRequestCreateOrderIikoCardDiscountItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Deliveries.Request.CreateOrder.IikoCardDiscountItem';
     ...
     * Sets position_id
     *
     * @param string $position_id Position ID of order item.
     *
     * @return self
     */
     ...
     * Sets sum
     *
     * @param float $sum Discount/surcharge sum.
     *
     * @return self
     */
