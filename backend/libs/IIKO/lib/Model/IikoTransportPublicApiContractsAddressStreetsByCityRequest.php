...
/**
 * IikoTransportPublicApiContractsAddressStreetsByCityRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoTransportPublicApiContractsAddressStreetsByCityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Address.StreetsByCityRequest';
     ...
     *
     * @param string $organization_id Organization ID details of which have to be returned.                Can be obtained by `/api/1/organizations` operation.
     *
     * @return self
     */
     ...
     *
     * @param bool|null $include_deleted Include deleted streets in response.
     *
     * @return self
     */
