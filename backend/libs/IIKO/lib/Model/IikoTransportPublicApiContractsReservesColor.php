...
/**
 * IikoTransportPublicApiContractsReservesColor Class Doc Comment
 *
 * @category Class
 * @description Color.
 * @package  IIKO
 ...
 */
class IikoTransportPublicApiContractsReservesColor implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Reserves.Color';
