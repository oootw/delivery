...
**retry_after** | **int** | Рекомендуемое количество миллисекунд, спустя которое следует повторить запрос. | [optional]
**code** | **string** | Код ошибки. | [optional]
**reason** | **string** | Причина по которой запрос не может быть выполнен по правилам бизнес-логики. | [optional]
