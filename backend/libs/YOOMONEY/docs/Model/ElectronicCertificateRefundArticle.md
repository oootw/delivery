...
------------ | ------------- | ------------- | -------------
**article_number** | **int** | Порядковый номер товара в корзине возврата. От 1 до 999 включительно. |
**payment_article_number** | **int** | Порядковый номер товара в одобренной корзине покупки (article_number в объекте платежа: https://yookassa.ru/developers/api#payment_object). От 1 до 999 включительно. |
...
**quantity** | **int** | Количество возвращаемых единиц товара. Формат: целое положительное число. |
