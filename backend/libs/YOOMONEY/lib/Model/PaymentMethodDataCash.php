...
/**
 * PaymentMethodDataCash Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodDataCash extends PaymentMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodDataCash';
     ...
     * Sets phone
     *
     * @param string|null $phone Телефон пользователя, на который придет смс с кодом платежа (для внесения наличных). Указывается в формате ITU-T E.164: https://ru.wikipedia.org/wiki/E.164, например 79000000000. Поле можно оставить пустым: пользователь сможет заполнить его при оплате на стороне ЮKassa.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/[0-9]{4,15}/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentMethodDataCash., must conform to the pattern /[0-9]{4,15}/.");
        }
