...
/**
 * DeliveryMethodData Class Doc Comment
 *
 * @category Class
 * @description The details of the invoice delivery method. Learn more about invoice delivery methods: https://yookassa.ru/developers/payment-acceptance/scenario-extensions/invoices/basics#send-invoice
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DeliveryMethodData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliveryMethodData';
