...
class Settlement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const TYPE_POSTPAYMENT = 'postpayment';
    public const TYPE_CONSIDERATION = 'consideration';
    ...
    public function getTypeAllowableValues()
    {
        return [
            ...
            self::TYPE_POSTPAYMENT,
            self::TYPE_CONSIDERATION,
        ];
    }
     ...
     * Sets type
     *
     * @param string $type Тип расчета. Перечень возможных значений * для Чеков от ЮKassa: https://yookassa.ru/developers/payment-acceptance/receipts/54fz/yoomoney/parameters-values#settlement-type * для сторонних онлайн-касс: https://yookassa.ru/developers/payment-acceptance/receipts/54fz/other-services/parameters-values#settlement-type
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param \YOOMONEY\Model\MonetaryAmount $amount Сумма расчета.
     *
     * @return self
     */
