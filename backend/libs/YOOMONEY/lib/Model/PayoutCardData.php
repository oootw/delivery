...
/**
 * PayoutCardData Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutCardData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PayoutCardData';
    ...
    public function setFirst6($first6)
    {
        ...
        if ((!preg_match("/[0-9]{6}/", ObjectSerializer::toString($first6)))) {
            throw new \InvalidArgumentException("invalid value for \$first6 when calling PayoutCardData., must conform to the pattern /[0-9]{6}/.");
        }
    ...
    public function setLast4($last4)
    {
        ...
        if ((!preg_match("/[0-9]{4}/", ObjectSerializer::toString($last4)))) {
            throw new \InvalidArgumentException("invalid value for \$last4 when calling PayoutCardData., must conform to the pattern /[0-9]{4}/.");
        }
