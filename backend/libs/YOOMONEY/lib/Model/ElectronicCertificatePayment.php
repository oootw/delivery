...
/**
 * ElectronicCertificatePayment Class Doc Comment
 *
 * @category Class
 ...
 */
class ElectronicCertificatePayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ElectronicCertificatePayment';
     ...
     * Sets amount
     *
     * @param \YOOMONEY\Model\MonetaryAmount $amount Сумма, которая спишется с электронного сертификата.
     *
     * @return self
     */
     ...
     * Sets basket_id
     *
     * @param string $basket_id Идентификатор корзины покупки, сформированной в НСПК.
     *
     * @return self
     */
    public function setBasketId($basket_id)
    {
        ...
        if ((!preg_match("/[0-9]{24}/", ObjectSerializer::toString($basket_id)))) {
            throw new \InvalidArgumentException("invalid value for \$basket_id when calling ElectronicCertificatePayment., must conform to the pattern /[0-9]{24}/.");
        }
