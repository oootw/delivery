...
/**
 * RecipientPosLinkRequest Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class RecipientPosLinkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RecipientPosLinkRequest';
     ...
     * Sets recipient
     *
     * @param \YOOMONEY\Model\Recipient $recipient Идентификатор торговой точки: https://yookassa.ru/developers/offline-payments/getting-started/basics#how-it-works-tablet, которую вы хотите привязать к кассовой ссылке.
     *
     * @return self
     */
