...
/**
 * AirlinePassenger Class Doc Comment
 *
 * @category Class
 ...
 */
class AirlinePassenger implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'AirlinePassenger';
     ...
     * Sets first_name
     *
     * @param string $first_name Passenger's first name. Only use Latin characters, for example, SERGEI.
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling AirlinePassenger., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling AirlinePassenger., must be bigger than or equal to 1.');
        }
     ...
     * Sets last_name
     *
     * @param string $last_name Passenger's last name. Only use Latin characters, for example, IVANOV.
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling AirlinePassenger., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling AirlinePassenger., must be bigger than or equal to 1.');
        }
