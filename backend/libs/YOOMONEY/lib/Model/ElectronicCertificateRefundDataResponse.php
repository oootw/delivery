...
/**
 * ElectronicCertificateRefundDataResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ElectronicCertificateRefundDataResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ElectronicCertificateRefundDataResponse';
     ...
     * Sets basket_id
     *
     * @param string $basket_id Идентификатор корзины возврата, сформированной в НСПК.
     *
     * @return self
     */
    public function setBasketId($basket_id)
    {
        ...
        if ((!preg_match("/[0-9]{24}/", ObjectSerializer::toString($basket_id)))) {
            throw new \InvalidArgumentException("invalid value for \$basket_id when calling ElectronicCertificateRefundDataResponse., must conform to the pattern /[0-9]{24}/.");
        }
     ...
     * Sets amount
     *
     * @param \YOOMONEY\Model\MonetaryAmount $amount Сумма, которая вернется на электронный сертификат.
     *
     * @return self
     */
