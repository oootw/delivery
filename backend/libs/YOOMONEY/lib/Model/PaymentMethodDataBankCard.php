...
/**
 * PaymentMethodDataBankCard Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodDataBankCard extends PaymentMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodDataBankCard';
