...
/**
 * CardDataForPayoutDestination Class Doc Comment
 *
 * @category Class
 ...
 */
class CardDataForPayoutDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CardDataForPayoutDestination';
     ...
     * Sets number
     *
     * @param string $number Номер банковской карты. Формат: только цифры, без пробелов. Пример: 5555555555554477
     *
     * @return self
     */
    public function setNumber($number)
    {
        ...
        if ((!preg_match("/[0-9]{16,19}/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling CardDataForPayoutDestination., must conform to the pattern /[0-9]{16,19}/.");
        }
