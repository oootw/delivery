...
/**
 * PaymentMethodMobileBalance Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodMobileBalance extends PaymentMethod
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodMobileBalance';
