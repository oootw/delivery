...
/**
 * PaymentOrderRecipientUtilities Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentOrderRecipientUtilities implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentOrderRecipientUtilities';
    ...
    protected static $openAPITypes = [
        ...
        'inn' => 'string',
        'kpp' => 'string',
        'bank' => '\YOOMONEY\Model\PaymentOrderBankUtilities'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!preg_match("/(?!00)\\d{10}/", $this->container['inn'])) {
            $invalidProperties[] = "invalid value for 'inn', must be conform to the pattern /(?!00)\\d{10}/.";
        }

        if ($this->container['kpp'] === null) {
            $invalidProperties[] = "'kpp' can't be null";
        }
        if (!preg_match("/[0-9]{9}/", $this->container['kpp'])) {
            $invalidProperties[] = "invalid value for 'kpp', must be conform to the pattern /[0-9]{9}/.";
        }
     ...
     * Sets name
     *
     * @param string $name Название получателя.
     *
     * @return self
     */
     ...
     * Sets inn
     *
     * @param string $inn ИНН получателя.
     *
     * @return self
     */
    public function setInn($inn)
    {
        ...
        if ((!preg_match("/(?!00)\\d{10}/", ObjectSerializer::toString($inn)))) {
            throw new \InvalidArgumentException("invalid value for \$inn when calling PaymentOrderRecipientUtilities., must conform to the pattern /(?!00)\\d{10}/.");
        }
     ...
     * Sets kpp
     *
     * @param string $kpp КПП получателя.
     *
     * @return self
     */
    public function setKpp($kpp)
    {
        ...
        if ((!preg_match("/[0-9]{9}/", ObjectSerializer::toString($kpp)))) {
            throw new \InvalidArgumentException("invalid value for \$kpp when calling PaymentOrderRecipientUtilities., must conform to the pattern /[0-9]{9}/.");
        }
     ...
     * Gets bank
     *
     * @return \YOOMONEY\Model\PaymentOrderBankUtilities
     */
     ...
     * Sets bank
     *
     * @param \YOOMONEY\Model\PaymentOrderBankUtilities $bank Банк получателя.
     *
     * @return self
     */
