...
/**
 * PaymentMethodSberbank Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodSberbank extends PaymentMethod
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodSberbank';
    ...
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/[0-9]{4,15}/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentMethodSberbank., must conform to the pattern /[0-9]{4,15}/.");
        }
