...
/**
 * ReceiverMobileBalance Class Doc Comment
 *
 * @category Class
 ...
 */
class ReceiverMobileBalance extends Receiver
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReceiverMobileBalance';
    ...
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/[0-9]{4,15}/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling ReceiverMobileBalance., must conform to the pattern /[0-9]{4,15}/.");
        }
