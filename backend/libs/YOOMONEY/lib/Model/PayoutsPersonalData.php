...
/**
 * PayoutsPersonalData Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutsPersonalData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PayoutsPersonalData';
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PayoutsPersonalData., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PayoutsPersonalData., must be bigger than or equal to 36.');
        }
