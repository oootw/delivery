...
/**
 * BankCardProduct Class Doc Comment
 *
 * @category Class
 ...
 */
class BankCardProduct implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BankCardProduct';
     ...
     * Sets code
     *
     * @param string $code Код карточного продукта. Пример: MCP
     *
     * @return self
     */
