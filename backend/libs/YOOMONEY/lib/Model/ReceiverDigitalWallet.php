...
/**
 * ReceiverDigitalWallet Class Doc Comment
 *
 * @category Class
 ...
 */
class ReceiverDigitalWallet extends Receiver
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReceiverDigitalWallet';
     ...
     * Sets account_number
     *
     * @param string $account_number Идентификатор электронного кошелька для пополнения. Максимум 20 символов.
     *
     * @return self
     */
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ReceiverDigitalWallet., must be smaller than or equal to 20.');
        }
