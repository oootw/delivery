...
/**
 * RefundDealInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class RefundDealInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RefundDealInfo';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'refund_settlements' => '\YOOMONEY\Model\SettlementRefundArrayInner[]'
    ];
    ...
    protected static $setters = [
        'id' => 'setId',
        'refund_settlements' => 'setRefundSettlements'
    ];
    ...
    protected static $getters = [
        'id' => 'getId',
        'refund_settlements' => 'getRefundSettlements'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('refund_settlements', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['refund_settlements'] === null) {
            $invalidProperties[] = "'refund_settlements' can't be null";
        }
     ...
     * Sets id
     *
     * @param string $id Идентификатор сделки. Берется из возвращаемого платежа.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RefundDealInfo., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling RefundDealInfo., must be bigger than or equal to 36.');
        }
    ...
    /**
     * Gets refund_settlements
     *
     * @return \YOOMONEY\Model\SettlementRefundArrayInner[]
     */
    public function getRefundSettlements()
    {
        return $this->container['refund_settlements'];
    }

    /**
     * Sets refund_settlements
     *
     * @param \YOOMONEY\Model\SettlementRefundArrayInner[] $refund_settlements Данные о распределении денег.
     *
     * @return self
     */
    public function setRefundSettlements($refund_settlements)
    {
        if (is_null($refund_settlements)) {
            throw new \InvalidArgumentException('non-nullable refund_settlements cannot be null');
        }
        $this->container['refund_settlements'] = $refund_settlements;
