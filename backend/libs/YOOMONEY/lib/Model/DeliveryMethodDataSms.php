...
/**
 * DeliveryMethodDataSms Class Doc Comment
 *
 * @category Class
 * @description Данные для выставления счета с доставкой ссылки на счет в смс.
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DeliveryMethodDataSms extends DeliveryMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliveryMethodDataSms';
    ...
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/[0-9]{4,15}/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling DeliveryMethodDataSms., must conform to the pattern /[0-9]{4,15}/.");
        }
