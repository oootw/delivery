 ...
 */
class PaymentRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Payment_recipient';
     ...
     * Sets account_id
     *
     * @param string $account_id Идентификатор магазина в ЮKassa.
     *
     * @return self
     */
     ...
     * Sets gateway_id
     *
     * @param string $gateway_id Идентификатор субаккаунта. Используется для разделения потоков платежей в рамках одного аккаунта.
     *
     * @return self
     */
