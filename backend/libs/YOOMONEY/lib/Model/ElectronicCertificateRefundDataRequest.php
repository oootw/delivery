...
/**
 * ElectronicCertificateRefundDataRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class ElectronicCertificateRefundDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ElectronicCertificateRefundDataRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['basket_id'] === null) {
            $invalidProperties[] = "'basket_id' can't be null";
        }
        if (!preg_match("/[0-9]{24}/", $this->container['basket_id'])) {
            $invalidProperties[] = "invalid value for 'basket_id', must be conform to the pattern /[0-9]{24}/.";
        }
     ...
     * Sets amount
     *
     * @param \YOOMONEY\Model\MonetaryAmount $amount Сумма, которая вернется на электронный сертификат, — значение totalCertAmount, которое вы получили в ФЭС НСПК в запросе на предварительное одобрение возврата (Refund Pre-Auth): https://www.nspk.ru/developer/api-fes#tag/Protokol-FES-NSPK-v1/operation/preAuthReturn.
     *
     * @return self
     */
     ...
     * Sets basket_id
     *
     * @param string $basket_id Идентификатор корзины возврата, сформированной в НСПК, — значение returnBasketId, которое вы получили в ФЭС НСПК в запросе на предварительное одобрение возврата (Refund Pre-Auth): https://www.nspk.ru/developer/api-fes#tag/Protokol-FES-NSPK-v1/operation/preAuthReturn.
     *
     * @return self
     */
    public function setBasketId($basket_id)
    {
        ...
        if ((!preg_match("/[0-9]{24}/", ObjectSerializer::toString($basket_id)))) {
            throw new \InvalidArgumentException("invalid value for \$basket_id when calling ElectronicCertificateRefundDataRequest., must conform to the pattern /[0-9]{24}/.");
        }
