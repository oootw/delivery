...
/**
 * PosLinkLastPayment Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class PosLinkLastPayment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PosLinkLastPayment';
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PosLinkLastPayment., must be smaller than or equal to 36.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PosLinkLastPayment., must be bigger than or equal to 36.');
        }
     ...
     * Sets status
     *
     * @param \YOOMONEY\Model\PaymentStatus $status Статус платежа. Возможные значения:  pending, succeeded и canceled. Подробнее про жизненный цикл платежа: https://yookassa.ru/developers/offline-payments/getting-started/payment-process#lifecycle
     *
     * @return self
     */
