...
/**
 * DeliveryMethodSelf Class Doc Comment
 *
 * @category Class
 ...
 */
class DeliveryMethodSelf extends DeliveryMethod
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliveryMethodSelf';
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $url when calling DeliveryMethodSelf., must be smaller than or equal to 2048.');
        }
