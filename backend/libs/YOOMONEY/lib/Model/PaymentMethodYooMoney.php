...
/**
 * PaymentMethodYooMoney Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodYooMoney extends PaymentMethod
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodYooMoney';
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((!preg_match("/[0-9]{11,33}/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling PaymentMethodYooMoney., must conform to the pattern /[0-9]{11,33}/.");
        }
