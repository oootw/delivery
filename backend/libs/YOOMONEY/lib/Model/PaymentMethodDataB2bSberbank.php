...
/**
 * PaymentMethodDataB2bSberbank Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodDataB2bSberbank extends PaymentMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodDataB2bSberbank';
    ...
    public function setPaymentPurpose($payment_purpose)
    {
        ...
        if ((mb_strlen($payment_purpose) > 210)) {
            throw new \InvalidArgumentException('invalid length for $payment_purpose when calling PaymentMethodDataB2bSberbank., must be smaller than or equal to 210.');
        }
        if ((mb_strlen($payment_purpose) < 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_purpose when calling PaymentMethodDataB2bSberbank., must be bigger than or equal to 1.');
        }
