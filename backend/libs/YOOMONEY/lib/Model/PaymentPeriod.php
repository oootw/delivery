...
/**
 * PaymentPeriod Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentPeriod implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentPeriod';
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['year'] > 2050)) {
            $invalidProperties[] = "invalid value for 'year', must be smaller than or equal to 2050.";
        }

        if (($this->container['year'] < 1920)) {
            $invalidProperties[] = "invalid value for 'year', must be bigger than or equal to 1920.";
        }
     ...
     * Sets month
     *
     * @param int $month Месяц периода. Например, 1 — январь.
     *
     * @return self
     */
    public function setMonth($month)
    {
        ...
        if (($month > 12)) {
            throw new \InvalidArgumentException('invalid value for $month when calling PaymentPeriod., must be smaller than or equal to 12.');
        }
        if (($month < 1)) {
            throw new \InvalidArgumentException('invalid value for $month when calling PaymentPeriod., must be bigger than or equal to 1.');
        }
     ...
     * Sets year
     *
     * @param int $year Payment period year. The value must be within the range 1920–2050. For example, 2025.
     *
     * @return self
     */
    public function setYear($year)
    {
        ...
        if (($year > 2050)) {
            throw new \InvalidArgumentException('invalid value for $year when calling PaymentPeriod., must be smaller than or equal to 2050.');
        }
        if (($year < 1920)) {
            throw new \InvalidArgumentException('invalid value for $year when calling PaymentPeriod., must be bigger than or equal to 1920.');
        }
