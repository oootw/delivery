...
/**
 * RefundSourcesData Class Doc Comment
 *
 * @category Class
 ...
 */
class RefundSourcesData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RefundSourcesData';
     ...
     * Sets account_id
     *
     * @param string $account_id Идентификатор магазина, для которого вы хотите провести возврат. Выдается ЮKassa, отображается в разделе Продавцы: https://yookassa.ru/my/marketplace/sellers личного кабинета (столбец shopId).
     *
     * @return self
     */
