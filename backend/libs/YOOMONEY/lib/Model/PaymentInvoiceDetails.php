...
/**
 * PaymentInvoiceDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentInvoiceDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Payment_invoice_details';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['id']) && (mb_strlen($this->container['id']) > 39)) {
     ...
     * Sets id
     *
     * @param string|null $id Invoice ID in YooMoney.
     *
     * @return self
     */
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 39)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentInvoiceDetails., must be smaller than or equal to 39.');
        }
        if ((mb_strlen($id) < 39)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentInvoiceDetails., must be bigger than or equal to 39.');
        }
