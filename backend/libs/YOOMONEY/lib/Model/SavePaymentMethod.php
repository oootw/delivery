...
/**
 * SavePaymentMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class SavePaymentMethod implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SavePaymentMethod';
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 16)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling SavePaymentMethod., number of items must be less than or equal to 16.');
        }
