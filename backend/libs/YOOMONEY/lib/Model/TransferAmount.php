...
/**
 * TransferAmount Class Doc Comment
 *
 * @category Class
 * @description Amount to be transferred to the store.
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TransferAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Transfer_amount';
    ...
    protected static $openAPITypes = [
        'value' => 'string',
        'currency' => '\YOOMONEY\Model\CurrencyCode'
    ];
     ...
     * Sets value
     *
     * @param string $value Сумма в выбранной валюте. Всегда дробное значение. Разделитель дробной части — точка, разделитель тысяч отсутствует. Количество знаков после точки зависит от выбранной валюты. Пример: 1000.00.
     *
     * @return self
     */
     ...
     * Gets currency
     *
     * @return \YOOMONEY\Model\CurrencyCode
     */
     ...
     * Sets currency
     *
     * @param \YOOMONEY\Model\CurrencyCode $currency currency
     *
     * @return self
     */
