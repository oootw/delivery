...
/**
 * PayoutCancellationDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutCancellationDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PayoutCancellationDetails';
    ...
    public const PARTY_PAYOUT_NETWORK = 'payout_network';
    public const REASON_INSUFFICIENT_FUNDS = 'insufficient_funds';
    public const REASON_FRAUD_SUSPECTED = 'fraud_suspected';
    public const REASON_ONE_TIME_LIMIT_EXCEEDED = 'one_time_limit_exceeded';
    public const REASON_PERIODIC_LIMIT_EXCEEDED = 'periodic_limit_exceeded';
    ...
    public const REASON_RECIPIENT_NOT_FOUND = 'recipient_not_found';
    public const REASON_RECIPIENT_CHECK_FAILED = 'recipient_check_failed';
    public const REASON_IDENTIFICATION_REQUIRED = 'identification_required';
    public const REASON_SELF_EMPLOYED_ANNUAL_LIMIT_EXCEEDED = 'self_employed_annual_limit_exceeded';
    ...
    public function getReasonAllowableValues()
    {
        return [
            ...
            self::REASON_ONE_TIME_LIMIT_EXCEEDED,
            self::REASON_PERIODIC_LIMIT_EXCEEDED,
            self::REASON_REJECTED_BY_PAYEE,
            self::REASON_GENERAL_DECLINE,
            self::REASON_ISSUER_UNAVAILABLE,
            self::REASON_RECIPIENT_NOT_FOUND,
            self::REASON_RECIPIENT_CHECK_FAILED,
            self::REASON_IDENTIFICATION_REQUIRED,
            self::REASON_SELF_EMPLOYED_ANNUAL_LIMIT_EXCEEDED,
        ];
    }
     ...
     * Sets reason
     *
     * @param string $reason Причина отмены выплаты. Перечень и описание возможных значений: для обычных выплат: https://yookassa.ru/developers/payouts/after-the-payout/declined-payouts#cancellation-details-reason, для выплат в рамках Безопасной сделки: https://yookassa.ru/developers/solutions-for-platforms/safe-deal/integration/payouts#declined-payouts-cancellation-details-reason.
     *
     * @return self
     */
