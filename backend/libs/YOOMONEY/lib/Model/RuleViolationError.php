...
/**
 * RuleViolationError Class Doc Comment
 *
 * @category Class
 * @description Запрос не может быть выполнен согласно правилам бизнес-логики.
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RuleViolationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RuleViolationError';
    ...
    public const CODE_REFUSAL = 'refusal';
