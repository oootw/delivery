 ...
 */
class PayoutDeal implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Payout_deal';
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PayoutDeal., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PayoutDeal., must be bigger than or equal to 36.');
        }
