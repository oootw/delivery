...
/**
 * GetSbpBanksResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class GetSbpBanksResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GetSbpBanksResponse';
    ...
    protected static $openAPITypes = [
        'type' => 'string',
        'items' => '\YOOMONEY\Model\SbpParticipantBank[]'
    ];
     ...
     * Gets items
     *
     * @return \YOOMONEY\Model\SbpParticipantBank[]
     */
     ...
     * Sets items
     *
     * @param \YOOMONEY\Model\SbpParticipantBank[] $items items
     *
     * @return self
     */
