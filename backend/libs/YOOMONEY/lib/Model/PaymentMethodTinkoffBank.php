...
/**
 * PaymentMethodTinkoffBank Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodTinkoffBank extends PaymentMethod
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodTinkoffBank';
