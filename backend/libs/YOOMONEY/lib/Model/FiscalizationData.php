...
/**
 * FiscalizationData Class Doc Comment
 *
 * @category Class
 ...
 */
class FiscalizationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FiscalizationData';
    ...
    protected static $openAPITypes = [
        'enabled' => 'bool',
        'provider' => '\YOOMONEY\Model\FiscalizationProvider'
    ];
     ...
     * Sets enabled
     *
     * @param bool $enabled В настройках магазина включена отправка чеков. Возможные значения: * true — магазин отправляет данные для чеков через ЮKassa; * false — магазин выключил отправку чеков через ЮKassa.
     *
     * @return self
     */
     ...
     * Gets provider
     *
     * @return \YOOMONEY\Model\FiscalizationProvider
     */
     ...
     * Sets provider
     *
     * @param \YOOMONEY\Model\FiscalizationProvider $provider provider
     *
     * @return self
     */
