...
/**
 * PaymentMethodDataYooMoney Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodDataYooMoney extends PaymentMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodDataYooMoney';
