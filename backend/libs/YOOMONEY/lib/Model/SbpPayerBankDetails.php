...
/**
 * SbpPayerBankDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class SbpPayerBankDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SbpPayerBankDetails';
    ...
    public function setBankId($bank_id)
    {
        ...
        if ((mb_strlen($bank_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $bank_id when calling SbpPayerBankDetails., must be smaller than or equal to 12.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{12}/", ObjectSerializer::toString($bank_id)))) {
            throw new \InvalidArgumentException("invalid value for \$bank_id when calling SbpPayerBankDetails., must conform to the pattern /[a-zA-Z0-9]{12}/.");
        }
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling SbpPayerBankDetails., must be smaller than or equal to 9.');
        }
        if ((!preg_match("/\\d{9}/", ObjectSerializer::toString($bic)))) {
            throw new \InvalidArgumentException("invalid value for \$bic when calling SbpPayerBankDetails., must conform to the pattern /\\d{9}/.");
        }
