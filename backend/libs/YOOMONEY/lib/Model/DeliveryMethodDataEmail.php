...
/**
 * DeliveryMethodDataEmail Class Doc Comment
 *
 * @category Class
 * @description Данные для выставления счета с отправкой по электронной почте.
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DeliveryMethodDataEmail extends DeliveryMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliveryMethodDataEmail';
    ...
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling DeliveryMethodDataEmail., must be smaller than or equal to 254.');
        }
