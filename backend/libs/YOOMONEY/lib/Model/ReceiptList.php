 ...
 */
class ReceiptList implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReceiptList';
     ...
     * Sets items
     *
     * @param \YOOMONEY\Model\Receipt[] $items items
     *
     * @return self
     */
