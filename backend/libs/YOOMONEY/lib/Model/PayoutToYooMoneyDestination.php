...
/**
 * PayoutToYooMoneyDestination Class Doc Comment
 *
 * @category Class
 ...
 */
class PayoutToYooMoneyDestination extends PayoutDestination
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PayoutToYooMoneyDestination';
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 33)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling PayoutToYooMoneyDestination., must be smaller than or equal to 33.');
        }
        if ((mb_strlen($account_number) < 11)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling PayoutToYooMoneyDestination., must be bigger than or equal to 11.');
        }
