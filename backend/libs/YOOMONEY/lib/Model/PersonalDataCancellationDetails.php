...
/**
 * PersonalDataCancellationDetails Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonalDataCancellationDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PersonalDataCancellationDetails';
    ...
    public const REASON_EXPIRED_BY_TIMEOUT = 'expired_by_timeout';
    ...
    {
        return [
            self::REASON_EXPIRED_BY_TIMEOUT,
        ];
    }
     ...
     * Sets party
     *
     * @param string $party Участник процесса, который принял решение о прекращении хранения персональных данных. Возможное значение: yoo_money — ЮKassa.
     *
     * @return self
     */
     ...
     * Sets reason
     *
     * @param string $reason Причина прекращения хранения персональных данных. Возможное значение: expired_by_timeout — истек срок хранения или использования персональных данных.
     *
     * @return self
     */
