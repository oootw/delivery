...
/**
 * B2bSberbankUntaxedVatData Class Doc Comment
 *
 * @category Class
 ...
 */
class B2bSberbankUntaxedVatData extends B2bSberbankVatData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'B2bSberbankUntaxedVatData';
