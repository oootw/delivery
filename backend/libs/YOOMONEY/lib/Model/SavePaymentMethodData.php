...
/**
 * SavePaymentMethodData Class Doc Comment
 *
 * @category Class
 ...
 */
class SavePaymentMethodData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SavePaymentMethodData';
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 16)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling SavePaymentMethodData., number of items must be less than or equal to 16.');
        }
