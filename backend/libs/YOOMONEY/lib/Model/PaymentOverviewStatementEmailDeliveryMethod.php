...
/**
 * PaymentOverviewStatementEmailDeliveryMethod Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentOverviewStatementEmailDeliveryMethod extends PaymentOverviewStatementDeliveryMethod
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentOverviewStatementEmailDeliveryMethod';
     ...
     * Sets email
     *
     * @param string $email Электронная почта пользователя для отправки справки. Адрес электронной почты должен соответствовать стандарту RFC 5322: https://www.ietf.org/rfc/rfc5322.txt. Пример: user@example.com.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling PaymentOverviewStatementEmailDeliveryMethod., must be smaller than or equal to 254.');
        }
