<?php
/**
 * PaymentMethodsConfirmationDataQr
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * PaymentMethodsConfirmationDataQr Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class PaymentMethodsConfirmationDataQr extends PaymentMethodsConfirmationData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodsConfirmationDataQr';
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling PaymentMethodsConfirmationDataQr., must be smaller than or equal to 2048.');
        }
