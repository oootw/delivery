...
/**
 * ConfirmationDataRedirect Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class ConfirmationDataRedirect extends ConfirmationData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConfirmationDataRedirect';
     ...
     * Sets return_url
     *
     * @param string $return_url URL, на который вернется пользователь после подтверждения или отмены платежа на веб-странице. Не более 2048 символов.
     *
     * @return self
     */
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling ConfirmationDataRedirect., must be smaller than or equal to 2048.');
        }
