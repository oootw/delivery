 ...
 */
class PosLinkInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PosLinkInfo';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'status' => '\YOOMONEY\Model\PosLinkStatus',
        'type' => '\YOOMONEY\Model\PosLinkType',
        'recipient' => '\YOOMONEY\Model\Recipient',
        'payment' => '\YOOMONEY\Model\PosLinkLastPayment'
    ];
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PosLinkInfo., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PosLinkInfo., must be bigger than or equal to 36.');
        }
     ...
     * Gets status
     *
     * @return \YOOMONEY\Model\PosLinkStatus
     */
     ...
     * Sets status
     *
     * @param \YOOMONEY\Model\PosLinkStatus $status status
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \YOOMONEY\Model\PosLinkType
     */
     ...
     * Sets type
     *
     * @param \YOOMONEY\Model\PosLinkType $type type
     *
     * @return self
     */
     ...
     * Sets recipient
     *
     * @param \YOOMONEY\Model\Recipient $recipient Идентификатор торговой точки: https://yookassa.ru/developers/offline-payments/getting-started/basics#how-it-works-tablet, которая привязана к кассовой ссылке.
     *
     * @return self
     */
     ...
     * Gets payment
     *
     * @return \YOOMONEY\Model\PosLinkLastPayment|null
     */
     ...
     * Sets payment
     *
     * @param \YOOMONEY\Model\PosLinkLastPayment|null $payment Данные о последнем платеже, который прошел по этой кассовой ссылке.
     *
     * @return self
     */
