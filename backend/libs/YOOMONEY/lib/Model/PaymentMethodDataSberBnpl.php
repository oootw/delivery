...
/**
 * PaymentMethodDataSberBnpl Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodDataSberBnpl extends PaymentMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodDataSberBnpl';
     ...
     * Sets phone
     *
     * @param string|null $phone The user's phone number. Sent to the partner and used for authorization in the \"Pay in installments\" service. Maximum 15 characters. Specified in the ITU-T E.164: https://ru.wikipedia.org/wiki/E.164 format. Example: 79000000000.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/[0-9]{4,15}/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentMethodDataSberBnpl., must conform to the pattern /[0-9]{4,15}/.");
        }
