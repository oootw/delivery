...
/**
 * PaymentMethodsConfirmationRedirect Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodsConfirmationRedirect extends PaymentMethodsConfirmation
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodsConfirmationRedirect';
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling PaymentMethodsConfirmationRedirect., must be smaller than or equal to 2048.');
        }
