...
/**
 * InvoiceCancellationDetails Class Doc Comment
 *
 * @category Class
 * @description Commentary for the canceled status: who canceled the invoice and for what reason.
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InvoiceCancellationDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvoiceCancellationDetails';
    ...
    public const REASON_INVOICE_CANCELED = 'invoice_canceled';
    public const REASON_INVOICE_EXPIRED = 'invoice_expired';
    public const REASON_GENERAL_DECLINE = 'general_decline';
    public const REASON_PAYMENT_CANCELED = 'payment_canceled';
    public const REASON_PAYMENT_EXPIRED_ON_CAPTURE = 'payment_expired_on_capture';
    ...
    {
        return [
            self::REASON_INVOICE_CANCELED,
            self::REASON_INVOICE_EXPIRED,
            self::REASON_GENERAL_DECLINE,
            self::REASON_PAYMENT_CANCELED,
            self::REASON_PAYMENT_EXPIRED_ON_CAPTURE,
        ];
    }
     ...
     * Sets party
     *
     * @param string $party The participant of the process who made the decision to cancel the invoice. Possible values: merchant — a seller of products and services (you); yoo_money — YooMoney.
     *
     * @return self
     */
