...
/**
 * PayoutDestination Class Doc Comment
 *
 * @category Class
 * @description The means of payment that YooMoney sends the payout to.
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PayoutDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PayoutDestination';
