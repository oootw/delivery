...
/**
 * ReceiverBankAccount Class Doc Comment
 *
 * @category Class
 ...
 */
class ReceiverBankAccount extends Receiver
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReceiverBankAccount';
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if ((mb_strlen($account_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $account_number when calling ReceiverBankAccount., must be smaller than or equal to 20.');
        }
        if ((!preg_match("/\\d{20}/", ObjectSerializer::toString($account_number)))) {
            throw new \InvalidArgumentException("invalid value for \$account_number when calling ReceiverBankAccount., must conform to the pattern /\\d{20}/.");
        }
    ...
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling ReceiverBankAccount., must be smaller than or equal to 9.');
        }
        if ((!preg_match("/\\d{9}/", ObjectSerializer::toString($bic)))) {
            throw new \InvalidArgumentException("invalid value for \$bic when calling ReceiverBankAccount., must conform to the pattern /\\d{9}/.");
        }
