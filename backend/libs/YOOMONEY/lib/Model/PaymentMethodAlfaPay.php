...
/**
 * PaymentMethodAlfaPay Class Doc Comment
 *
 * @category Class
 * @description Payment via Alfa Pay.
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PaymentMethodAlfaPay extends PaymentMethod
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodAlfaPay';
