...
/**
 * SavePaymentMethodSbpPayerBankDetails Class Doc Comment
 *
 * @category Class
 * @description Реквизиты счета, который использовался для привязки. Обязательный параметр для платежей в статусе succeeded. В остальных случаях может отсутствовать.
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SavePaymentMethodSbpPayerBankDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SavePaymentMethodSbpPayerBankDetails';
    ...
    public function setBankId($bank_id)
    {
        ...
        if ((mb_strlen($bank_id) > 12)) {
            throw new \InvalidArgumentException('invalid length for $bank_id when calling SavePaymentMethodSbpPayerBankDetails., must be smaller than or equal to 12.');
        }
        if ((!preg_match("/[a-zA-Z0-9]{12}/", ObjectSerializer::toString($bank_id)))) {
            throw new \InvalidArgumentException("invalid value for \$bank_id when calling SavePaymentMethodSbpPayerBankDetails., must conform to the pattern /[a-zA-Z0-9]{12}/.");
        }
