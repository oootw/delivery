...
class Webhook implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'event' => '\YOOMONEY\Model\NotificationEventType',
        'url' => 'string'
    ];
     ...
     * Gets event
     *
     * @return \YOOMONEY\Model\NotificationEventType
     */
     ...
     * Sets event
     *
     * @param \YOOMONEY\Model\NotificationEventType $event Событие: https://yookassa.ru/developers/using-api/webhooks#events, о котором уведомляет ЮKassa.
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url URL, на который ЮKassa отправляет уведомления.
     *
     * @return self
     */
