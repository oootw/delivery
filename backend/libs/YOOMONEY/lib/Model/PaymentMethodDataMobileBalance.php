...
/**
 * PaymentMethodDataMobileBalance Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodDataMobileBalance extends PaymentMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodDataMobileBalance';
     ...
     * Sets phone
     *
     * @param string $phone Телефон, с баланса которого осуществляется платеж. Указывается в формате ITU-T E.164: https://ru.wikipedia.org/wiki/E.164, например 79000000000.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/[0-9]{4,15}/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentMethodDataMobileBalance., must conform to the pattern /[0-9]{4,15}/.");
        }
