...
/**
 * ReceiptAdditionalUserProps Class Doc Comment
 *
 * @category Class
 ...
 */
class ReceiptAdditionalUserProps implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReceiptAdditionalUserProps';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['value']) > 234)) {
            $invalidProperties[] = "invalid value for 'value', the character length must be smaller than or equal to 234.";
        }
     ...
     * Sets name
     *
     * @param string $name Наименование дополнительного реквизита пользователя (тег в 54 ФЗ — 1085). Не более 64 символов.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 64)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ReceiptAdditionalUserProps., must be smaller than or equal to 64.');
        }
     ...
     * Sets value
     *
     * @param string $value Значение дополнительного реквизита пользователя (тег в 54 ФЗ — 1086). Не более 234 символов.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) > 234)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ReceiptAdditionalUserProps., must be smaller than or equal to 234.');
        }
