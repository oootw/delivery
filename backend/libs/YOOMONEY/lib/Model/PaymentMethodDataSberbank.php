...
/**
 * PaymentMethodDataSberbank Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentMethodDataSberbank extends PaymentMethodData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentMethodDataSberbank';
     ...
     * Sets phone
     *
     * @param string|null $phone Телефон пользователя, на который зарегистрирован аккаунт в SberPay. Необходим для подтверждения оплаты по смс (сценарий подтверждения external). Указывается в формате ITU-T E.164: https://ru.wikipedia.org/wiki/E.164, например 79000000000.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/[0-9]{4,15}/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling PaymentMethodDataSberbank., must conform to the pattern /[0-9]{4,15}/.");
        }
