...
/**
 * ConfirmationRedirect Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class ConfirmationRedirect extends Confirmation
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConfirmationRedirect';
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling ConfirmationRedirect., must be smaller than or equal to 2048.');
        }
     ...
     *
     * @param string $confirmation_url URL, на который необходимо перенаправить пользователя для подтверждения оплаты.
     *
     * @return self
     */
