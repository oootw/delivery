...
/**
 * CardRequestData Class Doc Comment
 *
 * @category Class
 ...
 */
class CardRequestData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CardRequestData';
    ...
    public function setNumber($number)
    {
        ...
        if ((!preg_match("/[0-9]{14,19}/", ObjectSerializer::toString($number)))) {
            throw new \InvalidArgumentException("invalid value for \$number when calling CardRequestData., must conform to the pattern /[0-9]{14,19}/.");
        }
    ...
    public function setExpiryYear($expiry_year)
    {
        ...
        if ((!preg_match("/[0-9]{4}/", ObjectSerializer::toString($expiry_year)))) {
            throw new \InvalidArgumentException("invalid value for \$expiry_year when calling CardRequestData., must conform to the pattern /[0-9]{4}/.");
        }
    ...
    public function setExpiryMonth($expiry_month)
    {
        ...
        if ((!preg_match("/[0-9]{2}/", ObjectSerializer::toString($expiry_month)))) {
            throw new \InvalidArgumentException("invalid value for \$expiry_month when calling CardRequestData., must conform to the pattern /[0-9]{2}/.");
        }
    ...
    public function setCardholder($cardholder)
    {
        ...
        if ((!preg_match("/[a-zA-Z '-]{0,26}/", ObjectSerializer::toString($cardholder)))) {
            throw new \InvalidArgumentException("invalid value for \$cardholder when calling CardRequestData., must conform to the pattern /[a-zA-Z '-]{0,26}/.");
        }
