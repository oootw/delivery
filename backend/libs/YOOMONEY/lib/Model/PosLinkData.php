 ...
 */
class PosLinkData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PosLinkData';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['link']) > 255)) {
            $invalidProperties[] = "invalid value for 'link', the character length must be smaller than or equal to 255.";
        }

        if ((mb_strlen($this->container['link']) < 10)) {
            $invalidProperties[] = "invalid value for 'link', the character length must be bigger than or equal to 10.";
        }
     ...
     * Sets link
     *
     * @param string $link Кассовая ссылка с платежной таблички. Чтобы получить ее, отсканируйте QR-код на табличке.
     *
     * @return self
     */
    public function setLink($link)
    {
        ...
        if ((mb_strlen($link) > 255)) {
            throw new \InvalidArgumentException('invalid length for $link when calling PosLinkData., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($link) < 10)) {
            throw new \InvalidArgumentException('invalid length for $link when calling PosLinkData., must be bigger than or equal to 10.');
        }
