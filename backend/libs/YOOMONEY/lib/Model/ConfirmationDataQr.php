...
/**
 * ConfirmationDataQr Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class ConfirmationDataQr extends ConfirmationData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConfirmationDataQr';
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling ConfirmationDataQr., must be smaller than or equal to 2048.');
        }
