...
/**
 * PersonalDataRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class PersonalDataRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PersonalDataRequest';
    ...
    public function setMetadata($metadata)
    {
        ...
        if ((count($metadata) > 16)) {
            throw new \InvalidArgumentException('invalid value for $metadata when calling PersonalDataRequest., number of items must be less than or equal to 16.');
        }
