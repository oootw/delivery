...
/**
 * ConfirmationDataMobileApplication Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class ConfirmationDataMobileApplication extends ConfirmationData
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ConfirmationDataMobileApplication';
    ...
    public function setReturnUrl($return_url)
    {
        ...
        if ((mb_strlen($return_url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $return_url when calling ConfirmationDataMobileApplication., must be smaller than or equal to 2048.');
        }
