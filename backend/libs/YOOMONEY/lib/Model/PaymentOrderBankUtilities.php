...
/**
 * PaymentOrderBankUtilities Class Doc Comment
 *
 * @category Class
 ...
 */
class PaymentOrderBankUtilities implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentOrderBankUtilities';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['bic']) < 9)) {
            $invalidProperties[] = "invalid value for 'bic', the character length must be bigger than or equal to 9.";
        }
        ...
        if ($this->container['correspondent_account'] === null) {
            $invalidProperties[] = "'correspondent_account' can't be null";
        }
     ...
     * Sets name
     *
     * @param string $name Name of the recipient's bank. Maximum of 45 characters.
     *
     * @return self
     */
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 45)) {
            throw new \InvalidArgumentException('invalid length for $name when calling PaymentOrderBankUtilities., must be smaller than or equal to 45.');
        }
     ...
     * Sets bic
     *
     * @param string $bic БИК банка получателя.
     *
     * @return self
     */
    public function setBic($bic)
    {
        ...
        if ((mb_strlen($bic) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling PaymentOrderBankUtilities., must be smaller than or equal to 9.');
        }
        if ((mb_strlen($bic) < 9)) {
            throw new \InvalidArgumentException('invalid length for $bic when calling PaymentOrderBankUtilities., must be bigger than or equal to 9.');
        }
        if ((!preg_match("/\\d{9}/", ObjectSerializer::toString($bic)))) {
            throw new \InvalidArgumentException("invalid value for \$bic when calling PaymentOrderBankUtilities., must conform to the pattern /\\d{9}/.");
        }
     ...
     * Sets account
     *
     * @param string $account Счет получателя в банке.
     *
     * @return self
     */
     ...
     *
     * @param string $correspondent_account Корреспондентский счет банка получателя.
     *
     * @return self
     */
