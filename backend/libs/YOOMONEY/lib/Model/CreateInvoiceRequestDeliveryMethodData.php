...
/**
 * CreateInvoiceRequestDeliveryMethodData Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class CreateInvoiceRequestDeliveryMethodData implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateInvoiceRequest_delivery_method_data';
     ...
     * Sets type
     *
     * @param string $type The code of the invoice delivery method.
     *
     * @return self
     */
     ...
     * Sets phone
     *
     * @param string $phone Номер телефона, на который ЮKassa отправит смс со ссылкой на счет.  Указывается в формате ITU-T E.164: https://ru.wikipedia.org/wiki/E.164, например 79000000000.
     *
     * @return self
     */
    public function setPhone($phone)
    {
        ...
        if ((!preg_match("/[0-9]{4,15}/", ObjectSerializer::toString($phone)))) {
            throw new \InvalidArgumentException("invalid value for \$phone when calling CreateInvoiceRequestDeliveryMethodData., must conform to the pattern /[0-9]{4,15}/.");
        }
     ...
     * Sets email
     *
     * @param string $email Адрес электронной почты, на который ЮKassa отправит письмо со ссылкой на счет.
     *
     * @return self
     */
    public function setEmail($email)
    {
        ...
        if ((mb_strlen($email) > 254)) {
            throw new \InvalidArgumentException('invalid length for $email when calling CreateInvoiceRequestDeliveryMethodData., must be smaller than or equal to 254.');
        }
