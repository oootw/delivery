...
/**
 * PaymentDealInfo Class Doc Comment
 *
 * @category Class
 * @package  YOOMONEY
 * @author   OpenAPI Generator team
 ...
 */
class PaymentDealInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentDealInfo';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'settlements' => '\YOOMONEY\Model\SettlementPaymentArrayInner[]'
    ];
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentDealInfo., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling PaymentDealInfo., must be bigger than or equal to 36.');
        }
     ...
     * Gets settlements
     *
     * @return \YOOMONEY\Model\SettlementPaymentArrayInner[]
     */
     ...
     * Sets settlements
     *
     * @param \YOOMONEY\Model\SettlementPaymentArrayInner[] $settlements Данные о распределении денег.
     *
     * @return self
     */
