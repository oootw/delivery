...
namespace App\Application\Loyalty\Query\GetLoyaltyHistoryByCustomerId;
 ...
 */
class GetLoyaltyHistoryByCustomerIdFetcher
{
     ...
     */
    public function fetch(GetLoyaltyHistoryByCustomerIdQuery $query): array
    {
