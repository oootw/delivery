...
class GetWorkspacesByMemberUserIdFetcher
{
     ...
     * @return WorkspaceDTO[]
     */
    public function fetch(GetWorkspacesByMemberUserIdQuery $query): array
    {
        $memberships = $this->memberships->findAllByUserId($query->userId);
