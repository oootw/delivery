...
------------ | ------------- | ------------- | -------------
**id** | **string** | Order ID. |
**pos_id** | **string** | POS order ID. | [optional]
...
**order** | [**\IIKO\Model\IikoTransportPublicApiContractsTableOrdersResponseTableOrder**](IikoTransportPublicApiContractsTableOrdersResponseTableOrder.md) | Order creation details.  &gt; Field is filled up if \&quot;creationStatus\&quot;&#x3D;\&quot;Success\&quot;. | [optional]
