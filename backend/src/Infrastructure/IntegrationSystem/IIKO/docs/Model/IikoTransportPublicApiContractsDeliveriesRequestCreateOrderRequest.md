...
**order** | [**\IIKO\Model\IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDeliveryOrder**](IikoTransportPublicApiContractsDeliveriesRequestCreateOrderDeliveryOrder.md) | Order. |
