...
**items** | [**\IIKO\Model\IikoTransportPublicApiContractsTerminalsTerminalGroup[]**](IikoTransportPublicApiContractsTerminalsTerminalGroup.md) | Items for organization. |
