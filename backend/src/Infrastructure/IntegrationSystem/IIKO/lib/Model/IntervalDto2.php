...
/**
 * IntervalDto2 Class Doc Comment
 *
 * @category Class
 * @description Menu availability time intervals
 * @package  IIKO
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class IntervalDto2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IntervalDto2';
     ...
     *
     * @param string $organization_id Organization GUID
     *
     * @return self
     */
     ...
     * Sets from_time
     *
     * @param string $from_time Start time
     *
     * @return self
     */
