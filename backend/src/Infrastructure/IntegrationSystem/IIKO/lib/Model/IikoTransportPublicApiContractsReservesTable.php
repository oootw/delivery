...
/**
 * IikoTransportPublicApiContractsReservesTable Class Doc Comment
 *
 * @category Class
 * @description Table.
 * @package  IIKO
 ...
 */
class IikoTransportPublicApiContractsReservesTable implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Reserves.Table';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('seating_capacity', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['seating_capacity'] === null) {
            $invalidProperties[] = "'seating_capacity' can't be null";
        }
     ...
     * Sets number
     *
     * @param int $number Number of table.
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string $name Table name specified in the organization settings.
     *
     * @return self
     */
     ...
     *
     * @param int $seating_capacity Seating capacity of the table.
     *
     * @return self
     */
    public function setSeatingCapacity($seating_capacity)
    {
        if (is_null($seating_capacity)) {
            throw new \InvalidArgumentException('non-nullable seating_capacity cannot be null');
        }
     ...
     * Sets is_deleted
     *
     * @param bool $is_deleted Is table deleted.
     *
     * @return self
     */
     ...
     * Sets pos_id
     *
     * @param string $pos_id POS table Id.
     *
     * @return self
     */
