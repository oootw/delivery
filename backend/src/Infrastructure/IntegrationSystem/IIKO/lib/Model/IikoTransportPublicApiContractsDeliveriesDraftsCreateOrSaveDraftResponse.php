...
/**
 * IikoTransportPublicApiContractsDeliveriesDraftsCreateOrSaveDraftResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoTransportPublicApiContractsDeliveriesDraftsCreateOrSaveDraftResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Deliveries.Drafts.CreateOrSaveDraftResponse';
     ...
     * Sets order_id
     *
     * @param string $order_id Order draft order ID.
     *
     * @return self
     */
