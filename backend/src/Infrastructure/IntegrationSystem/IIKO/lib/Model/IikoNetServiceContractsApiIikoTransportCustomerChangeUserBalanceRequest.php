...
/**
 * IikoNetServiceContractsApiIikoTransportCustomerChangeUserBalanceRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoNetServiceContractsApiIikoTransportCustomerChangeUserBalanceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoNet.Service.Contracts.Api.iikoTransport.Customer.ChangeUserBalanceRequest';
     ...
     * Sets sum
     *
     * @param float|null $sum Sum of balance change. Must be positive.
     *
     * @return self
     */
