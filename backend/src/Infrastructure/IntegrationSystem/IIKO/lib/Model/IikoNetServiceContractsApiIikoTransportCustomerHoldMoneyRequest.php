...
/**
 * IikoNetServiceContractsApiIikoTransportCustomerHoldMoneyRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoNetServiceContractsApiIikoTransportCustomerHoldMoneyRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoNet.Service.Contracts.Api.iikoTransport.Customer.HoldMoneyRequest';
     ...
     * Sets transaction_id
     *
     * @param string|null $transaction_id Predefined transaction id. Random if empty.
     *
     * @return self
     */
     ...
     * Sets comment
     *
     * @param string|null $comment Additional information about holding. Can be null.
     *
     * @return self
     */
