...
/**
 * IikoNetServiceContractsApiIikoTransportCustomerDeleteCustomersRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoNetServiceContractsApiIikoTransportCustomerDeleteCustomersRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoNet.Service.Contracts.Api.iikoTransport.Customer.DeleteCustomersRequest';
     ...
     * Sets customer_ids
     *
     * @param string[] $customer_ids Customer IDs for logical deletion.
     *
     * @return self
     */
