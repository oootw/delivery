...
/**
 * IikoTransportPublicApiContractsOrganizationsOrganizationInfo Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoTransportPublicApiContractsOrganizationsOrganizationInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    public const DISCRIMINATOR = 'response_type';
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Organizations.OrganizationInfo';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['response_type'] = static::$openAPIModelName;
    }
     ...
     * Sets id
     *
     * @param string $id Organization ID.                Can be obtained by `/api/1/organizations` operation.
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Organization`s code.
     *
     * @return self
     */
