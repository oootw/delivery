...
/**
 * IikoTransportPublicApiContractsDeliveriesResponseOrderPositionWithSum Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoTransportPublicApiContractsDeliveriesResponseOrderPositionWithSum implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoTransport.PublicApi.Contracts.Deliveries.Response.Order.PositionWithSum';
     ...
     * Sets position_id
     *
     * @param string $position_id Order item position ID.
     *
     * @return self
     */
     ...
     * Sets sum
     *
     * @param float $sum Position discount sum.
     *
     * @return self
     */
