...
/**
 * IncomingServiceCreateItem Class Doc Comment
 *
 * @category Class
 * @package  IIKO
 * @author   OpenAPI Generator team
 ...
 */
class IncomingServiceCreateItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IncomingServiceCreateItem';
