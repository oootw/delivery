...
/**
 * IikoNetServiceContractsApiIikoTransportReportTransportTransactionsCertificateReportItem Class Doc Comment
 *
 * @category Class
 ...
 */
class IikoNetServiceContractsApiIikoTransportReportTransportTransactionsCertificateReportItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'iikoNet.Service.Contracts.Api.iikoTransport.Report.TransportTransactionsCertificateReportItem';
     ...
     * Sets series
     *
     * @param string|null $series Series. Can be null.
     *
     * @return self
     */
     ...
     * Sets status_name
     *
     * @param string|null $status_name Status name. Can be null.
     *
     * @return self
     */
